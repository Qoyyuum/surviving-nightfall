...
class ThirdPersonCamera:
    ...
    def update(self):
        ...
        rotated_x = rotated_offset.x * math.cos(angle_rad) - rotated_offset.z * math.sin(angle_rad)
        rotated_z = rotated_offset.x * math.sin(angle_rad) + rotated_offset.z * math.cos(angle_rad)
        
        desired_position = self.target.position + Vec3(rotated_x, rotated_offset.y, rotated_z)
