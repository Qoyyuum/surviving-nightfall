...
class WaveManager:
    ...
    def spawn_enemy(self, enemy_type):
        ...
        distance = random.uniform(GameConfig.SPAWN_RADIUS_MIN, GameConfig.SPAWN_RADIUS_MAX)
        ...
        if enemy:
            ...
            print(f"Spawned {enemy_type} at ({spawn_x:.1f}, {spawn_z:.1f}) - Total enemies: {len(self.enemies)}")
